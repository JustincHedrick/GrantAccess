  ...
  return (
    <section>
      <form className='relative' onSubmit={handleSubmit}>
        ...
        <input className="block w-full items-center py-1 pr-1 pl-8 border-1 border-neutral-50 rounded" type="text" placeholder="Search for grants…" value={query} onChange={handleChange} />
