...
export default function Footer() {
    ...
    {/* List of Tribute */}
            <div class="">
              ...
              <p class="mb-4">
                <a href="/aboutus" class="text-gray-600">Project Case Study</a>
              </p>
              <p class="mb-4">
    ...
    {/* Useful Links */}
            <div class="">
              ...
              <p class="mb-4">
                <a href="/aboutus" class="text-gray-600">About Us</a>
              </p>
              <p class="mb-4">
                <a href="/login" class="text-gray-600">Sign In</a>
              </p>
              <p class="mb-4">
                <a href="/signup" class="text-gray-600">Get Involved</a>
              </p>
              <p>
                <a href="/faq" class="text-gray-600">Help</a>
              </p>
            </div>
            <div class="">
