    ...
    <label for="dropzone-file" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
      ...
      <div id="myTabContent">
        <div className="p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
          ...
          <hr></hr>
          <h1>....</h1>
          <ol className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="REVIEWS" role="tabpanel" aria-labelledby="dashboard-tab">
