            ...
            <div class="grid grid-cols-6 gap-4 mb-8 w-full ">
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/1qzPec_GHdDTmwysrL9pvMPvrgzGHlb4g/view?usp=sharing" class="text-purple-600 hover:text-purple-500 underline text-sm">Download Resume</a>
